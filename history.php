...
<html>
  <head>
    ...
    <title>History_BatteredBooks</title>
    <meta charset="utf-8">
                        ...
                        <div class="nave_menu wow fadeInUp" data-wow-duration="1s">
  						  ...
  						  <li><a id="logout" href="logout.php"><span class="glyphicon glyphicon-log-out">&nbsp;Logout</span></a></li>
     					    ...
     					    <div class="form-group">
      					    	<input type="text" maxlength=13 name="ISBN" class="form-control search" placeholder="Search by ISBN">
     					    </div>
...
$x=$_SESSION['CUR_USR'];
$q="select TITLE,AUT,ISBN,CP,SP,AGE,BID from BOOK where USR='$x'";
...
while($row=mysqli_fetch_assoc($sql))
{
     ...
     <div class="container">
                    ...
                    <div class="row">
					  ...
					  <tr><td>&nbsp;</td></tr>
					  <tr><td>
					     	<a href="deleteHistory.php?BID='.$v0.'&OWNER='.$x.'"><font style="color:#e84c3d;"><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</font></a>
					     </td>
