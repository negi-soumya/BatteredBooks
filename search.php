...
<html>
  <head>
    ...
    <title>Search_BatteredBooks</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target="#navmenu">
                        ...
                        <div class="nave_menu wow fadeInUp" data-wow-duration="1s">
  						  ...
  						  <li><a id="logout" href="logout.php"><span class="glyphicon glyphicon-log-out">&nbsp;Logout</span></a></li>
     					    ...
     					    <div class="form-group">
      					    	<input name="ISBN" type="text" maxlength=13 class="form-control search" placeholder="Search by ISBN">
     					    </div>
       ...
       <section id="home_search" class="home_search"> <!--home secton-->
...
$x=$_POST["ISBN"];
$q="select USER.USR as UUSR,EID,ROOM,BLOCK,TITLE,AUT,ISBN,CP,SP,AGE,BID from USER join BOOK on USER.USR=BOOK.USR where ISBN='$x'";
