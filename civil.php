...
<html>
  <head>
    ...
    <title>Civil_BatteredBooks</title>
    <meta charset="utf-8">
...
$q="select USER.USR as UUSR,EID,ROOM,BLOCK,TITLE,AUT,ISBN,CP,SP,AGE,BID from USER join BOOK on USER.USR=BOOK.USR where CAT='Civil'";
